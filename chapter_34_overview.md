...
Example 33.1. Applying the JaCoCo plugin
...
Example 33.2. Configuring JaCoCo plugin settings
...
Table 33.1. Gradle defaults for JaCoCo properties
|属性	|Gradle 默认值|
|--
...
Example 33.3. Configuring test task
...
Example 33.4. Configuring test task
...
Table 33.2. Default values of the JaCoCo Task extension
...
例33.5.使用应用程序插件生成代码覆盖率数据

Example 33.5. Using application plugin to generate code coverage data
...
例33.6.通过applicationCodeCoverageReport生成覆盖率报告

Example 33.6. Coverage reports generated by applicationCodeCoverageReport
...
Table 33.3. JaCoCo plugin - tasks
...
Table 33.4. JaCoCo plugin - dependency configurations
