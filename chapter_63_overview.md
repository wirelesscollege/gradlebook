...
63.3.1. Configuring projects from an init script
...
Example 63.2. Declaring external dependencies for an init script
...
Example 63.3. An init script with external dependencies
...
Example 63.4. Using plugins in init scripts
